...
| livenessProbe.httpGet.port | int | `20244` |  |
...
| tolerations | list | `[{"key":"CriticalAddonsOnly","operator":"Exists"},{"effect":"NoSchedule","key":"node-role.kubernetes.io/master","operator":"Exists"},{"effect":"NoSchedule","key":"node.kubernetes.io/not-ready","operator":"Exists"}]` | Kube-Router labels for tolerations pod assignment |
